<h1>DYIEasyAPI Arduino Library</h1>

<p><strong>DYIEasyAPI</strong> is an Arduino library that simplifies interfacing with APIs on ESP8266-based NodeMCU boards. It provides an easy-to-use interface for quick prototyping of network and IoT applications, enabling seamless communication over the internet. With DYIEasyAPI, you can easily command your devices, read data from them, and exchange information with third-party services.</p>
...
<p>Develop Your Interface with easy APIs! The <strong>DYIEasyAPI</strong> library includes functions commonly used in personal projects with ESP8266 on NodeMCU boards. The purpose is to simplify network and IoT application development, abstracting communication technicalities from logical functionalities. Use this library to achieve quick communication over the network and internet, such as commanding devices, reading data, and exchanging information with third-party services.</p>
...
<ol>
  <li><strong>Download the Library:</strong>
    <ul>
      <li>Go to the releases section of the DYIEasyAPI repository on GitHub: <a href="https://github.com/yourusername/DYIEasyAPI">Link to Repository</a>.</li>
      <li>Download the latest release version of the library by clicking on the "DYIEasyAPI.zip" file.</li>
    </ul>
  </li>
  <li><strong>Install the Library in Arduino IDE:</strong>
    <ul>
      ...
      <li>Browse to the location where you stored the "DYIEasyAPI.zip" file and select it.</li>
      <li>Click on the "Open" button.</li>
    </ul>
  </li>
  <li><strong>Verify Installation:</strong>
    <ul>
      <li>After successful installation, you should see "DYIEasyAPI" listed under <strong>Sketch</strong> &gt; <strong>Include Library</strong>.</li>
    </ul>
  </li>
</ol>
...
<p>The DYIEasyAPI library has no additional dependencies other than the ESP8266 library, which is essential for using NodeMCU boards.</p>

<h2>Usage:</h2>

<p>The DYIEasyAPI library consists of three modules: Wifi, Webserver, and SendRequest. Here's a brief overview of each module and its important functions:</p>
...
<p>DYIEasyAPI is specifically designed for ESP8266 boards, particularly NodeMCU. It is tested with Arduino IDE version 1.8.13.</p>
...
<p>This Library was generated by Eng. Mahmoud Darawsheh while doing some IoT projects, with the aim of making it closer to standard MVC (Model-View-Controller) routes used in many programming languages. By abstracting communication technicalities from logical functionalities, the DYIEasyAPI library provides an efficient and easy-to-use solution for API communication and networking tasks on ESP8266-based NodeMCU boards.</p>
